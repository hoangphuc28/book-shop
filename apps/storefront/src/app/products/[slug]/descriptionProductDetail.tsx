...
<table className=" col-span-2 table-auto border-collapse w-full text-left text-gray-600 text-sm">
    <tbody><tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">Mã hàng</th>
        <th className="py-2 px-4 border border-gray-300 ">Blank, Brown, Red</th>
      </tr>
      <tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">Tác giả</th>
        <th className="py-2 px-4 border border-gray-300 ">Latex</th>
      </tr>
      <tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">NXB</th>
        <th className="py-2 px-4 border border-gray-300 ">55kg</th>
      </tr>
      <tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">Trọng lượng</th>
        <th className="py-2 px-4 border border-gray-300 ">55kg</th>
      </tr>
      <tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">Số trang</th>
        <th className="py-2 px-4 border border-gray-300 ">55kg</th>
      </tr>
      <tr>
        <th className="py-2 px-4 border border-gray-300 w-40 font-medium">Kích thước bao bì</th>
        <th className="py-2 px-4 border border-gray-300 ">55kg</th>
      </tr>
    </tbody></table>
